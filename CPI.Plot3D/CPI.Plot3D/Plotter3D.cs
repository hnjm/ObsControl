...
namespace CPI.Plot3D
{
    ...
    public class Plotter3D : IDisposable
    {
        ...
        public void Forward(double distance, Pen PenColor)
        {
            Point3D oldLocation = location;
            ...
            if (IsPenDown)
            {
                canvas.DrawLine(PenColor, oldLocation.GetScreenPosition(cameraLocation), this.Location.GetScreenPosition(cameraLocation));
